...
public class sensorData implements org.apache.thrift.TBase<sensorData, sensorData._Fields>, java.io.Serializable, Cloneable, Comparable<sensorData> {
  ...
  public sensorData setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public sensorData setValue(int value) {
    this.value = value;
    setValueIsSet(true);
    return this;
  }
  ...
  public sensorData setTimestamp(@org.apache.thrift.annotation.Nullable java.lang.String timestamp) {
    this.timestamp = timestamp;
    return this;
  }
